        ...
        },
        {
          ...
          fields: [
            ...
            contentField,
            {
              ...
              required: true,
              options: [
                { label: "Action Network Form", value: "actionNetwork" },
            ...
            },
            {
              ...
              admin: {
                ...
                components: { Field: "@/payload/components/ANFormBuilder#ANFormBuilder" },
              },
            },
            {
              name: "submitLabel",
              ...
              admin: { condition: (_, s) => s?.formType === "actionNetwork" },
            },
            {
              name: "successMessage",
              type: "text",
