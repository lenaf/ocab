...
export const FloatingArrayField: ArrayFieldClientComponent = (
  props,
) => {
  const { path } = props;
  const fields = useFormFields(([fields]) => fields);
  const { dispatchFields, setModified } = useForm();
  const [aspectRatio, setAspectRatio] = useState<"desktop" | "mobile">(
    "desktop",
  );
  ...
  Object.keys(fields || {}).forEach((key) => {
    const match = key.match(
      new RegExp(`^${path.replace(/\./g, "\\.")}\\.(\\d+)\\.image$`),
    );
    if (match) {
  ...
  const handleMouseDown = useCallback(
    (e: React.MouseEvent, index: number, type: "drag" | "resize") => {
      ...
      const position =
        aspectRatio === "desktop" ? item?.position : item?.mobilePosition;
      if (!position) return;
  ...
  const handleMouseMove = useCallback(
    (e: MouseEvent) => {
      ...
      const posField =
        aspectRatio === "desktop" ? "position" : "mobilePosition";
      const itemPath = `${path}.${activeIndex}.${posField}`;

      if (isDragging) {
        const newX = Math.max(
          0,
          Math.min(100, startPos.current.itemX + deltaX),
        );
        const newY = Math.max(
          0,
          Math.min(100, startPos.current.itemY + deltaY),
        );
        ...
        const newW = Math.max(
          50,
          Math.min(500, startPos.current.itemW + (deltaX * rect.width) / 100),
        );
        const newH = Math.max(
          50,
          Math.min(500, startPos.current.itemH + (deltaY * rect.height) / 100),
        );
      ...
      {validItems.length > 0 && (
        <div style={{ marginTop: "1rem" }}>
            ...
            >
              <button
                ...
                style={{
                  padding: "0.5rem 1rem",
                  backgroundColor:
                    aspectRatio === "desktop" ? "#0070f3" : "white",
              ...
              <button
                ...
                style={{
                  padding: "0.5rem 1rem",
                  backgroundColor:
                    aspectRatio === "mobile" ? "#0070f3" : "white",
          ...
          >
            ...
            >
              {activeIndex !== null
                ? `Fine-tune Item ${activeIndex + 1}`
                : "Fine-tune Position (select an item above)"}
            </summary>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          dispatchFields({
                            type: "UPDATE",
                            path: `${path}.${activeIndex}.position.x`,
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          dispatchFields({
                            type: "UPDATE",
                            path: `${path}.${activeIndex}.position.y`,
                            value: Number(e.target.value),
                          })
                        }
                        style={{
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          dispatchFields({
                            type: "UPDATE",
                            path: `${path}.${activeIndex}.position.width`,
                            value: Number(e.target.value),
                          })
                        }
                        style={{
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          dispatchFields({
                            type: "UPDATE",
                            path: `${path}.${activeIndex}.position.height`,
                            value: Number(e.target.value),
                          })
                        }
                        style={{
                  ...
                  >
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          dispatchFields({
                            type: "UPDATE",
                            path: `${path}.${activeIndex}.mobilePosition.x`,
                            value: Number(e.target.value),
                          })
                        }
                        style={{
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          dispatchFields({
                            type: "UPDATE",
                            path: `${path}.${activeIndex}.mobilePosition.y`,
                            value: Number(e.target.value),
                          })
                        }
                        style={{
                    ...
                    <div>
                      ...
                      <input
                        type="number"
                        value={
                          validItems[activeIndex]?.mobilePosition?.width ?? 200
                        }
                        onChange={(e) =>
                          dispatchFields({
                            type: "UPDATE",
                            path: `${path}.${activeIndex}.mobilePosition.width`,
                            value: Number(e.target.value),
                          })
                        }
                        style={{
                    ...
                    <div>
                      ...
                      <input
                        type="number"
                        value={
                          validItems[activeIndex]?.mobilePosition?.height ?? 200
                        }
                        onChange={(e) =>
                          dispatchFields({
                            type: "UPDATE",
                            path: `${path}.${activeIndex}.mobilePosition.height`,
                            value: Number(e.target.value),
                          })
                        }
                        style={{
